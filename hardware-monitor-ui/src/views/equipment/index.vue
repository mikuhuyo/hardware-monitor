<template>
  <div class="equipment-container">
    ...
    <div class="contBox">
      <div v-for="(item, ind) in tableData" :class="['item', {'active': item.status}]" :key="ind">
        <el-switch v-model="item.status" @change="handleClick(item)" class="switch" active-color="#57CE9E"
          inactive-color="#AFB6CA"></el-switch>
        <div class="topList">
          <div class="title">
    ...
    <div class="pagination" v-if="total > 15">
      <el-pagination @size-change="handleSizeChange" @current-change="handleCurrentChange" :page-sizes="[15, 30, 40, 50]"
        :page-size="pageSize" :current-page="page" layout="total, sizes, prev, pager, next, jumper" :total="total">
      </el-pagination>
    </div>
